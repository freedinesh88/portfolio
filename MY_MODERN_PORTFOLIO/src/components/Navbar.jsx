...
export default function Navbar() {
  ...
  return (
    ...
    <div className="flex item-center space-x-2">
      ...
      <div className="text-2xl font-bold text-white hidden sm:block">Dinesh</div>
    </div>
    ...
    <div className="hidden lg:block">
      <a href="#contact" className="bg-gradient-to-r from-pink-500 to-blue-500 text-white px-4 py-2 rounded-full font-medium shadow-lg hover:opacity-90 transition-opacity duration-300">
        Reach Out
      </a>
    </div>
