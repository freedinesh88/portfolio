  ...
  const [formData,setFormData]=useState({
    ...
    return(
        ...
        <div className="flex flex-col">
            ...
            className={`p-3 rounded-md bg-white/10 border ${errors.name ? "border-red-500" : "border-grey-500"} text-white focus:outline-none focus:border-blue-500`}/>
        ...
        <div className="flex flex-col">
            ...
            onChange={handelChange}
            className={`p-3 rounded-md bg-white/10 border ${errors.email ? "border-red-500" : "border-grey-500"} text-white focus:outline-none focus:border-blue-500`}/>
        ...
        <div className="flex flex-col">
         ...
         value={formData.service}
            onChange={handelChange}
             className={`p-3 rounded-md bg-white/10 border ${errors.service ? "border-red-500" : "border-grey-500"} text-white focus:outline-none focus:border-blue-500`}
         >
        ...
        {formData.service && formData.service !== "others" && (
            ...
            onChange={handelChange}
            className={`p-3 rounded-md bg-white/10 border ${errors.budget ? "border-red-500" : "border-grey-500"} text-white focus:outline-none focus:border-blue-500`}/>
         ...
         <div className="flex flex-col">
            ...
            value={formData.idea}
            onChange={handelChange}
            className={`p-3 rounded-md bg-white/10 border ${errors.idea ? "border-red-500" : "border-grey-500"} text-white focus:outline-none focus:border-blue-500`}
            >
            </textarea>
        ...
        {
            status && (
                <p className={`text-sm ${status==="success" ? "text-green-400" : status==="error" ? "text-red-400" : "Something went wrong"}`}>
